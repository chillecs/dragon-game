...
attackBtn2.addEventListener('click', () => {
    ...
    if (currentHealth1 === 0) {
        ...
        backToSelectionBtn.textContent = 'Back to Selection';
        backToSelectionBtn.classList.add('back-btn');
        backToSelectionBtn.addEventListener('click', () => {
            localStorage.removeItem('selectedDragons');
            window.location.reload();
        });
        document.body.appendChild(backToSelectionBtn);
        return;
    }
